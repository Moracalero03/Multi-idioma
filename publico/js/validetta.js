...
(function($) {
    ...
    var Validetta = {}, // Plugin Class
        ...
        defaults = {
            ...
            // ErrorTemplate: '<span class="text-danger errorTemplateClass ">Error messages will be here !</span>',
            display: 'inline', // Error display options, // bubble / inline
    ...
    Validetta.prototype = {
        ...
        init: function(e) {
            ...
            else if (this.handler === true) { this.options.onError.call(this, e); return false; } else return this.options.onValid.call(this, e); // if form is valid call onValid() function
        },
