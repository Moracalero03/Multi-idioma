...
!(function(a) {
    ...
    var b = {},
        c = {},
        d = new RegExp(
            /^(minChecked|maxChecked|minSelected|maxSelected|minLength|maxLength|equalTo|different|regExp|remote|callback)\[(\w{1,15})\]/i
        ),
        e = new RegExp(
        ...
        j = {
            ...
            equalTo: function(a, b) {
                return (
                    b.form.querySelector('input[name="' + a.arg + '"]').value === a.val ||
                    g.notEqual
                );
            },
            ...
            creditCard: function(a) {
                ...
                for (f = 0; i > f; f++)
                    (d = i - f),
                    (e = parseInt(c.substring(d - 1, d), 10)),
                    f % 2 === 1 ? ((h = 2 * e), h > 9 && (h = 1 + (h - 10))) : (h = e),
                    (j += h);
            ...
            maxChecked: function(b, c) {
                var d = a(
                    c.form.querySelectorAll(
                        'input[type=checkbox][name="' + b.el.name + '"]'
                    )
                );
                if (0 === d.index(b.el)) {
                    var e = d.filter(":checked").length;
                    if (0 !== e)
                        return e <= b.arg || g.maxChecked.replace("{count}", b.arg);
                }
            },
            ...
            maxSelected: function(a) {
                return null !== a.val ?
                    a.val.length <= a.arg || g.maxSelected.replace("{count}", a.arg) :
                    void 0;
            },
            minSelected: function(a) {
                return (
                    (null !== a.val && a.val.length >= a.arg) ||
                    g.minSelected.replace("{count}", a.arg)
                );
            },
            radio: function(a) {
                var b = this.form.querySelectorAll(
                    'input[type=radio][name="' + a.name + '"]:checked'
                ).length;
                return 1 === b;
            },
            regExp: function(a, b) {
    ...
    (b.prototype = {
        ...
        events: function() {
            ...
            a(this.form).submit(function(a) {
                ...
                (a(this.form)
                    ...
                    .on("click", function(a) {
                        return (
                            (c = b.form.querySelectorAll(
                                '[data-validetta][type=checkbox][name="' + this.name + '"]'
                            )),
                            b.init(a)
                        );
                    })),
                a(this.form).on("reset", function() {
                    return (
                        a(
                            b.form.querySelectorAll(
                                "." + b.options.errorClass + ", ." + b.options.validClass
                            )
                        ).removeClass(b.options.errorClass + " " + b.options.validClass),
                        b.reset()
                    );
                });
        },
        init: function(a) {
            return (
                ...
                "submit" !== a.type ?
                void 0 :
                "pending" === this.handler ?
                !1 :
                this.handler === !0 ?
                (this.options.onError.call(this, a), !1) :
                this.options.onValid.call(this, a)
            );
        },
        checkFields: function(b) {
            ...
            for (var g = 0, h = c.length; h > g; g++)
                if (!c[g].disabled) {
                    ...
                    (this.tmp = {}),
                    (this.tmp = { el: l, val: n, parent: this.parents(l) });
                    for (var p = 0, q = o.length; q > p; p++) {
                        var r,
                            s = o[p].match(d);
                        if (
                            (null !== s ?
                                ("undefined" != typeof s[2] && (this.tmp.arg = s[2]),
                                    (r = s[1])) :
                                (r = o[p]),
                                ("" !== n || "required" === r || "equalTo" === r) &&
                                j.hasOwnProperty(r) &&
                                ((k = j[r](e.tmp, e)), "undefined" != typeof k && k !== !0))
                        ) {
                    ...
                    "" !== m
                        ?
                        (f.push({ field: l, errors: m }),
                            this.addErrorClass(this.tmp.parent),
                            this.window.open.call(this, l, m)) :
                        "undefined" != typeof this.tmp.remote ?
                        this.checkRemote(l, b) :
                        ("undefined" != typeof k ?
                            this.addValidClass(this.tmp.parent) :
                            a(this.tmp.parent).removeClass(
                                this.options.errorClass + " " + this.options.validClass
                            ),
                            (k = void 0));
                }
        },
        checkRemote: function(b, c) {
            var d = {},
                e = {},
                f = b.name || b.id;
            "undefined" == typeof this.remoteCache && (this.remoteCache = {}),
                (e[f] = this.tmp.val),
                (d = a.extend(!0, {}, { data: e },
            ...
            if ("undefined" != typeof h)
                switch (h.state) {
                    ...
                    case "resolved":
                        h.result.valid === !1 ?
                            (this.addErrorClass(this.tmp.parent),
                                this.window.open.call(this, b, h.result.message)) :
                            this.addValidClass(this.tmp.parent);
                }
            else {
                var i = this.xhr[f];
                "undefined" != typeof i && "pending" === i.state() && i.abort(),
                    (h = this.remoteCache[g] = { state: "pending", event: c.type }),
                    this.remoteRequest(d, h, b, f);
            }
        },
        remoteRequest: function(b, c, d, e, f) {
            var g = this;
            a(this.tmp.parent).addClass("validetta-pending"),
                (this.xhr[e] = a
                    .ajax(b)
                    .done(function(b) {
                        "object" != typeof b && (b = JSON.parse(b)),
                            ...
                            (c.result = b),
                            "submit" === c.event ?
                            ((g.handler = !1), a(g.form).trigger("submit")) :
                            b.valid === !1 ?
                            (g.addErrorClass(g.tmp.parent),
                                g.window.open.call(g, d, b.message)) :
                            g.addValidClass(g.tmp.parent);
                    })
                    .fail(function(a, b) {
                        if ("abort" !== b) {
                            var d =
        ...
        window: {
            open: function(b, c) {
                ...
                if (
                    ("undefined" == typeof d && (d = b[0].parentNode), !d.querySelectorAll("." + this.options.errorTemplateClass).length)
                ) {
                    var e = document.createElement("span");
                    if (
                        ((e.className =
                                this.options.errorTemplateClass +
                                " " +
                                this.options.errorTemplateClass +
                                "--" +
                                this.options.bubblePosition),
                        ...
                        var f,
                            ...
                            h = 0;
                        (f = a(b).position()),
                        "bottom" === this.options.bubblePosition ?
                            (h = b.offsetHeight) :
                            (g = b.offsetWidth),
                            (e.innerHTML = ""),
                            (e.style.top = f.top + h + this.options.bubbleGapTop + "px"),
                            (e.style.left = f.left + g + this.options.bubbleGapLeft + "px");
                    }
        ...
        reset: function(a) {
            var b = {};
            b =
                "undefined" == typeof a || (a.length > 1 && "checkbox" !== a[0].type) ?
                this.form.querySelectorAll("." + this.options.errorTemplateClass) :
                this.parents(a[0]).querySelectorAll(
                    "." + this.options.errorTemplateClass
                );
            for (var c = 0, d = b.length; d > c; c++)
                this.window.close.call(this, b[c]);
            this.handler = !1;
        },
        ...
        parents: function(a) {
            for (
                var b = parseInt(a.getAttribute("data-vd-parent-up"), 10) || 0, c = 0; b >= c; c++
            )
                a = a.parentNode;
            return a;
        },
    ...
    (a.fn.validetta = function(c, d) {
        return (
            a.validettaLanguage &&
            (g = a.extend(!0, {}, g, a.validettaLanguage.messages)),
            "undefined" != typeof d && (g = a.extend(!0, {}, g, d)),
            this.each(function() {
                new b(this, c);
            })
        );
