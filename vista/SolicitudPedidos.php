...
?>
    ...
    <form action="../publico/php/procesarProductos.php" method="POST" id="frmDinamico">                    
                <div class="p-4">
                    ...
                    <input class="form-control" type="text" name="txtNombreSP" data-seccion="formSolicitudPedidos"  data-valor="PLNomCompleto" data-validetta="required">
                    ...
                    <input class="form-control" type="email" name="txtCorreoSP" data-seccion="formSolicitudPedidos"  data-valor="PLcorreo" data-validetta="required">
                    ...
                    <input class="form-control" type="text" name="txtIdentificacionSP" data-seccion="formSolicitudPedidos"  data-valor="PLNumIndentificacion" data-validetta="required">
                    ...
                    <input class="form-control" type="text" name="txtTelefonoSP" data-seccion="formSolicitudPedidos"  data-valor="PLNumTelefono" data-validetta="required">
                    ...
                    <textarea class="form-control" name="txtDireccionSP" cols="15" rows="1" data-seccion="formSolicitudPedidos"  data-valor="PLDireccion" data-validetta="required"></textarea>
                ...
                <div class="modal-dialog" role="document">
                    ...
                    <form action="../publico/php/procesarFactura.php" method="post" id="formFacturar">
                            ...
                            <div class="<?=$col6?>">
                                ...
                                <input class="form-control" type="text" name="txtNomTarjetaSP" data-seccion="formSolicitudPedidos"  data-valor="PLNomTarjeta" data-validetta="required">

                                <span class="warnings" id="warningsNombreTarjeta"  data-section="formSolicitudPedidos"  data-value="spanNombreTarjeta"></span>
                            ...
                            <div class="<?=$col6?>">
                                ...
                                <input class="form-control" type="text" name="txtNumTarjetaSP" data-seccion="formSolicitudPedidos"  data-valor="PLNumTarjeta" data-validetta="required">
                            ...
                            <div class="<?=$col6?>">
                                ...
                                <input class="form-control" type="text" name="txtComprobanteSP" data-seccion="formSolicitudPedidos"  data-valor="PLComprobante" readonly>
                            </div>
                            </div>
